...
parser.add_argument('-c', '--compile', action=argparse.BooleanOptionalAction)
parser.add_argument('--config', type=str, required=False, default="conf.ndjson", help="Config file")
parser.add_argument('-dfs', '--dfs', action=argparse.BooleanOptionalAction, help="breadth-first search")
